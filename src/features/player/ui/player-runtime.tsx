 ...
 *
 * Loaded on demand through `player.tsx`, which is the code-split boundary —
 * everything this module reaches (the questions view, the summary, their
 * answer controls) stays off the detail surface until someone enters the
 * player.
 */
